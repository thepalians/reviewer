...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .stat.total .val{color:#0ea5e9}.stat.open .val{color:#3498db}.stat.progress .val{color:#f39c12}.stat.closed .val{color:#27ae60}.stat.high .val{color:#e74c3c}
        ...
        .btn-primary{background:#0ea5e9;color:#fff}.btn-primary:hover{background:#5568d3;color:#fff}
                    ...
                    <?php else: ?>
                        <?php foreach ($tickets as $ticket): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="ticket-view.php?id=<?php echo $ticket['id']; ?>" style="color:#0ea5e9;text-decoration:none">
