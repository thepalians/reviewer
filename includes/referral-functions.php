...
function getWhatsAppShareLink($referral_code) {
    ...
    $message = "Join " . (defined('APP_NAME') ? APP_NAME : 'TestProduct') . " and earn money by completing tasks! Use my referral code: {$referral_code}\n\n{$link}";
...
function getTwitterShareLink($referral_code) {
    $link = generateReferralLink($referral_code);
    $message = "Join " . (defined('APP_NAME') ? APP_NAME : 'TestProduct') . " and earn money! Use my code: {$referral_code}";
